...
This way we can code-review relevant commits, and make sure we all know what's up.
...
The name of the package can be found in the package's `package.json['name']` property
